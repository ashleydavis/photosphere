#!/bin/bash
DESCRIPTION="Zig replicate/verify: Database state tracks lastModifiedAt and lastSyncedAt across add/sync/repair and syncs early-out when identical"
