...
// Every native integration is stubbed for now: callbacks return no-op unsubscribe
// functions, data getters return empty/sensible defaults, and config is held in an
// in-memory Map. This is enough to mount the real UI and reach the About page; real
// database, sync, vault, share, and file-picker support will be added later.
//
