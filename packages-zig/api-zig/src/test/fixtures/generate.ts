...
// Run with: bun run src/test/fixtures/generate.ts (from packages-zig/api-zig).
//
...
import { saveDatabaseConfig, updateDatabaseConfig } from "../../../../../packages/api/src/lib/database-config";
import { saveDatabaseState } from "../../../../../packages/api/src/lib/database-state";
