...
- [x] Fixed and verified (10x clean)
- Suite: mobile smoke tests (`bun run test:android` / `bun run test:ios`), seen via `bun run test:android`
...
- Recurrences:
  - 2026-07-06, local 10x loop (`bun run test:android`), recurred on run 5 of 10, test 3 (open-database). Runs 1 to 4 passed; within run 5 tests 0 to 2 passed before the click for `database-list-item-0` found no element and `Database opened` never logged.
  - 2026-07-06, local 10x loop (`bun run test:android`), recurred on run 10 of 10, test 21 (import-video). Runs 1 to 9 passed; within run 10 the open-database step opened the dialog, then the click for `database-list-item-0` found no element and `Database opened` never logged.
  - 2026-07-06, local 10x loop (`bun run test:android`), recurred on run 2 of 10, test 4 (import-photos). Run 1 passed; within run 2 tests 0 to 3 passed (including test 3 open-database), then test 4's open-database step opened the dialog, the click for `database-list-item-0` found no element, and `Database opened` never logged.
  - 2026-07-06, skill loop iteration 2 of 100 (`bun run test:android`), recurred on run 6 of 10; click for `database-list-item-0` found no element and `Database opened` never logged.
  - 2026-07-06, skill loop iteration 3 of 100 (`bun run test:android`), recurred on run 5 of 10; same missing-list-item click.
  - 2026-07-06, skill loop iteration 5 of 100 (`bun run test:android`), recurred on run 3 of 10; same missing-list-item click.
  - 2026-07-06, skill loop iteration 6 of 100 (`bun run test:android`), recurred on run 9 of 10; same missing-list-item click.
  - 2026-07-06, skill loop iteration 8 of 100 (`bun run test:android`), recurred on run 3 of 10; same missing-list-item click.
  - 2026-07-06, skill loop iteration 9 of 100 (`bun run test:android`), recurred on run 3 of 10; same missing-list-item click.
  - 2026-07-06, skill loop iteration 10 of 100 (`bun run test:android`), recurred on run 9 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 13 of 100 (`bun run test:android`), recurred on run 4 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 14 of 100 (`bun run test:android`), recurred on run 5 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 16 of 100 (`bun run test:android`), recurred on run 1 of 10; same missing-list-item click (failed on the iteration's first run, but the mode is flaky across the loop, not deterministic).
  - 2026-07-07, skill loop iteration 19 of 100 (`bun run test:android`), recurred on run 4 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 20 of 100 (`bun run test:android`), recurred on run 8 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 23 of 100 (`bun run test:android`), recurred on run 9 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 25 of 100 (`bun run test:android`), recurred on run 9 of 10; same missing-list-item click.
  - 2026-07-07, skill loop iteration 28 of 100 (`bun run test:android`), recurred on run 4 of 10; same missing-list-item click.
  - 2026-07-09, single script run (`bun run test:android`), recurred on run 3 of 10, test 3 (open-database); same missing-list-item click.
...
- Suite: mobile smoke tests (`bun run test:android`), test 1 (load-fixture)
- Pattern: `Asset server returned HTTP 000 for thumbnail [0-9a-f-]+`
- Fix commit: none yet
- First seen: 2026-07-09, single script run (`bun run test:android`), failed on run 5 of 10, test 1 (load-fixture). Runs 1 to 4 passed (each served the thumbnail fine).
- Recurrences: none
