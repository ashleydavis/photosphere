...
export interface ISecretQuickCreateDialogProps {
...
//
export function SecretQuickCreateDialog({ open, secretType, defaultName, onClose, onSave }: ISecretQuickCreateDialogProps) {
