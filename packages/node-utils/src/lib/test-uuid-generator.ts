...
export class TestUuidGenerator implements IUuidGenerator {
    ...
    constructor() {
        ...
        process.stderr.write('[@@@@@@] TestUuidGenerator instantiated for deterministic UUIDs\n');
    }
    ...
    generate(): string {
        ...
        // Write to stderr to ensure it's visible in all scenarios
        process.stderr.write(`[@@@@@@] ${uuid}\n`);
        return uuid;
    }
