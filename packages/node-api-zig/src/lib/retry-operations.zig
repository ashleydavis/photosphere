...
//
pub const InfoOperation = struct {
    ...
    //
    pub fn run(self: *InfoOperation, io: std.Io) !?IFileInfo {
...
pub const WriteOperation = struct {
    ...
    // Writes the file.
    //
    pub fn run(self: *WriteOperation, io: std.Io) !void {
...
//
pub const ComputeStorageHashOperation = struct {
    // Allocates the storage implementation's temporary data.
    allocator: std.mem.Allocator,
    ...
    //
    pub fn run(self: *ComputeStorageHashOperation, io: std.Io) ![Sha256.digest_length]u8 {
...
//
pub const CopyStreamOperation = struct {
    ...
    //
    pub fn run(self: *CopyStreamOperation, io: std.Io) !void {
...
//
pub const MerkleTreeExistsOperation = struct {
    // Allocates the storage implementation's temporary data.
    allocator: std.mem.Allocator,
    ...
    //
    pub fn run(self: *MerkleTreeExistsOperation, io: std.Io) !bool {
...
//
pub const LoadMerkleTreeOperation = struct {
    ...
    //
    pub fn run(self: *LoadMerkleTreeOperation, io: std.Io) !?IMerkleTree {
...
//
pub const SaveMerkleTreeOperation = struct {
    ...
    //
    pub fn run(self: *SaveMerkleTreeOperation, io: std.Io) !void {
