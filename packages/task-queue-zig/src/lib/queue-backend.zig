...
pub const IQueueBackend = struct {
    ...
    pub const VTable = struct {
        ...
        addTask: *const fn (ptr: *anyopaque, allocator: std.mem.Allocator, io: std.Io, @"type": []const u8, data: std.json.Value, source: []const u8, taskId: ?[]const u8) anyerror![]const u8,
    ...
    //
    pub fn addTask(self: IQueueBackend, allocator: std.mem.Allocator, io: std.Io, @"type": []const u8, data: std.json.Value, source: []const u8, taskId: ?[]const u8) anyerror![]const u8 {
        return self.vtable.addTask(self.ptr, allocator, io, @"type", data, source, taskId);
    }
